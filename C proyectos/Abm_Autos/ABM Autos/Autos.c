...
void darDeAltaAuto(STR_Auto losAutos[],int cantidadAutos)
{
    ...
    f_i_PedirStringAlfaNumerico(losAutos[index].patente,10,"Ingrese la patente del auto:");

    strupr (losAutos[index].patente);
...
void altaTrabajo (STR_Trabajo trabajos[],int cantidadTrabajos, STR_Auto autos[],int cantidadAutos,STR_Servicio servicios[])
{
    ...
    do
    {
        ...
        f_i_PedirStringAlfaNumerico(auxPatente,10,"Ingrese la patente del auto:");
        ...
        if ( invalido == 1)
        {
            printf("\nEsa patente no esta registrada.\n");
        };
    }
    while (1==invalido);
...
void dardeBajaAuto(STR_Auto losAutos[], int cantidadAutos)
{
    ...
    f_i_PedirStringAlfaNumerico(auxPatente,10,"Ingrese la patente del auto a dar de baja:");
...
void modificarAuto (STR_Auto losAutos[],int cantidadAutos)
{
    ...
    f_i_PedirStringAlfaNumerico(auxPatente, 10, "Ingrese la patente del auto a modificar:\n");
...
void mostrarTrabajos (STR_Trabajo trabajos[],int cantidadTrabajos, STR_Auto autos[],STR_Servicio servicios[])
{
    ...
    for(i=0; i<cantidadTrabajos; i++)
    {
        ...
        {
            printf("%10s-%10s-%4d\n",trabajos[i].patente, servicios[trabajos[i].idServicio-20000].descripcion, servicios[trabajos[i].idServicio-20000].precio );
        };
    };
